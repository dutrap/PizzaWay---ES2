...
RN - 02 Validação de dados pessoais: para efetuar o cadastro, as pessoas devem possuir endereço e telefone valido e atualizado.
...
RN – 06 Atualização de dados: O cliente que não realizar um pedido durante 6 meses, quando solicitar um novo pedido, o sistema deve informar que os dados de endereço e telefone devem ser atualizados.
...
RF-06 Login de Usuário: O Login deve ser composto pelo nome completo do usuário e a senha composta por no mínimo 6 caracteres (entre números e letras apenas);
RF-07 Sistema para rodar o aplicativo: O aplicativo deverá rodar nos seguintes sistemas:
- Android
-Ios
...
O sistema devera ser de fácil utilização.
RNF-03 Disponibilidade de relatório do pedido:
...
RNF-04 O sistema deverá armazenar os dados de acesso: 
O aplicativo deverá armazenar os dados de acesso do usuário bem como seu histórico de compras.
RNF-05 Relatório mensal e diário do fluxo de vendas: 
